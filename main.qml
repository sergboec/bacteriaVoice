...
//    FontLoader { id:museoSlab; source: "qrc:/font/Museo_Slab.otf" }
    ...
    Rectangle{
        ...
        Rectangle{
            ...
            Text{
                ...
                font.pixelSize: mainWidnow.height * 1.15 * 1.15 / 45
                text: "Resilent\nEc(h)osystem"
                color: "white"
            }
